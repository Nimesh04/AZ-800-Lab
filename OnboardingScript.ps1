...
try {
    ...
    $env:SUBSCRIPTION_ID = "e7885274-6707-4324-83a7-f4a7090d8ea0";
    $env:RESOURCE_GROUP = "az800-lab-rg";
    $env:TENANT_ID = "6062e144-6b42-4dd6-930f-0b79aef5e8c6";
    $env:LOCATION = "eastus2";
    $env:AUTH_TYPE = "token";
    $env:CORRELATION_ID = "75139704-3684-4400-a59a-1b408c4ebf8d";
